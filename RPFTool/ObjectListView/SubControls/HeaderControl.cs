...
namespace BrightIdeasSoftware
{
    ...
    public class HeaderControl : NativeWindow
    {
        ...
        protected Rectangle DrawFilterIndicator(Graphics g, Rectangle r) {
            ...
            Image indicator = RPFTool.Properties.Resources.ColumnFilterIndicator;
            int x = r.Right - width;
        ...
        private int CalculateFilterIndicatorWidth(Rectangle r) {
            if (RPFTool.Properties.Resources.ColumnFilterIndicator == null || r.Width < 48)
                return 0;
            return RPFTool.Properties.Resources.ColumnFilterIndicator.Width + 1;
        }
